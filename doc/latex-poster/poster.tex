...
\institute[shortinst]{\textbf{Tomas Bata University in Zlín - Faculty of Applied Informatics}} 
...
\begin{column}{\colwidth}
  ...
  \begin{block}{1. Motivation}
    ...
    the functionality of students' solutions often requires additional network resources (servers, clients, and more),
    making the assessment process more time-consuming. Network applications \textbf{often have varied behaviors
    ...
    relying on external network resources. It will help students and especially teachers, for whom this 
    solution will \textbf{save a considerable amount of time} and allow them to focus on more important work 
    at the faculty. This solution is not limited to educational institutions, it can also be used in 
  ...
  \begin{block}{2. Conclusion}
    ...
    \hspace{2em}This thesis includes not only the \textbf{Network Application Testing Tool (NATT)} but also the 
    Configuration Editor, documentation for the tool, example projects and configurations, a new set consisting of 8 tasks 
    for a network programming course, GitLab repositories for each task and additional tools for the course.
...
\begin{column}{\colwidth}
  ...
  \begin{alertblock}{3. Main features of testing tool}
    ...
    integrated into \textbf{CI/CD pipelines} on platforms like GitLab and GitHub. This tool tests, 
  ...
  \begin{block}{4. Principle of the testing tool}
    ...
    These two diagrams illustrate how application testing is performed using the \textbf{NATT}
...
\begin{column}{\colwidth}
  ...
  \begin{exampleblock}{6. Usage of testing tool}
    ...
    \begin{enumerate}
      ...
      \item \textbf{Professional Use:} Ensures efficient testing of network applications in software development.
  ...
  \begin{block}{7. NATT Config Editor \& VS Code Extension}
    ...
    \begin{minipage}{0.7\textwidth}
      ...
      also available an \textbf{extension for VS Code}, which offers the same functions as the mentioned editor.
    \end{minipage}
    \hfill
